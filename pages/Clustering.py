...
# --- KMeans Clustering ---
    ...
    plot_df = df.sort_values('Number of Accidents', ascending=True)
    ...
    sorted_barangays = plot_df['Barangay'].tolist()
    ...
    fig2.update_layout(
            ...
            width=800,
            height=800,
                yaxis=dict(categoryorder='array', categoryarray=sorted_barangays)
